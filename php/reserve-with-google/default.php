...
define('PAGE_CANONICAL', 'https://certxa.com/reserve-with-google');
define('PAGE_BREADCRUMBS', json_encode([
  ['name'=>'Home','url'=>'https://certxa.com/overview'],
  ['name'=>'Reserve With Google','url'=>'https://certxa.com/reserve-with-google'],
]));
define('PAGE_SCHEMA', json_encode([
  [
    '@type'       => 'WebPage',
    '@id'         => 'https://certxa.com/reserve-with-google',
    ...
    'url'         => 'https://certxa.com/reserve-with-google',
