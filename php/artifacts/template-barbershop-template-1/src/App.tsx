...
const GALLERY_IMAGES = [
  ...
  {
    url: 'https://images.pexels.com/photos/2806539/pexels-photo-2806539.jpeg?auto=compress&cs=tinysrgb&w=800',
    alt: 'Barber at work',
  },
  {
    ...
    <div className="font-sans bg-neutral-950 text-white overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.pexels.com/photos/1570807/pexels-photo-1570807.jpeg?auto=compress&cs=tinysrgb&w=1600"
        ...
        >
          <div className="relative">
            <div className="relative z-10 grid grid-cols-2 gap-4">
              <img
                src="https://images.pexels.com/photos/2806539/pexels-photo-2806539.jpeg?auto=compress&cs=tinysrgb&w=700"
                alt="Barber working"
                className="w-full h-72 object-cover"
              />
              <img
                src="https://images.pexels.com/photos/3998429/pexels-photo-3998429.jpeg?auto=compress&cs=tinysrgb&w=700"
                alt="Precision fade"
