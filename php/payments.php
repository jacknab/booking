...
define('PAGE_CANONICAL', 'https://certxa.com/payments.php');
define('PAGE_BREADCRUMBS', json_encode([
  ['name'=>'Home','url'=>'https://certxa.com/overview.php'],
  ['name'=>'Payment Solutions','url'=>'https://certxa.com/payments.php'],
]));
define('PAGE_SCHEMA', json_encode([
  [
    '@type'       => 'WebPage',
    '@id'         => 'https://certxa.com/payments.php',
    ...
    'url'         => 'https://certxa.com/payments.php',
