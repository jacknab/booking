...
define('PAGE_CANONICAL', 'https://certxa.com/custom-website-builder.php');
define('PAGE_BREADCRUMBS', json_encode([
  ['name'=>'Home','url'=>'https://certxa.com/overview.php'],
  ['name'=>'Website Builder','url'=>'https://certxa.com/custom-website-builder.php'],
]));
define('PAGE_SCHEMA', json_encode([
  [
    '@type'       => 'WebPage',
    '@id'         => 'https://certxa.com/custom-website-builder.php',
    ...
    'url'         => 'https://certxa.com/custom-website-builder.php',
