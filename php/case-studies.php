...
define('PAGE_CANONICAL','https://certxa.com/case-studies.php');
define('PAGE_BREADCRUMBS', json_encode([
  ['name'=>'Home','url'=>'https://certxa.com/overview.php'],
  ['name'=>'Success Stories','url'=>'https://certxa.com/case-studies.php'],
]));
    ...
    <div class="feature-block">
      <div class="feature-content">
        ...
        <div style="margin-top:20px;display:flex;gap:10px;">
          ...
          <a href="/online-booking.php" style="font-size:.85rem;color:var(--plum);font-weight:600;display:flex;align-items:center;gap:4px;">Online Booking features →</a>
        </div>
      </div>
  ...
  <div class="container" style="max-width:920px;">
    <div class="feature-block reverse">
      <div class="feature-content">
        ...
        <div style="margin-top:20px;display:flex;gap:10px;">
          <a href="#" class="btn btn-primary">Start My Free Trial</a>
          <a href="/client-reviews.php" style="font-size:.85rem;color:var(--plum);font-weight:600;display:flex;align-items:center;gap:4px;">Client Reviews features →</a>
        </div>
      </div>
  ...
  <div class="container" style="max-width:920px;">
    <div class="feature-block">
      <div class="feature-content">
        ...
        <div style="margin-top:20px;display:flex;gap:10px;">
          <a href="#" class="btn btn-primary">Start My Free Trial</a>
          <a href="/nail-salon-software.php" style="font-size:.85rem;color:var(--plum);font-weight:600;display:flex;align-items:center;gap:4px;">Nail salon features →</a>
        </div>
      </div>
