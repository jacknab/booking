...
$canonicalUrl = 'https://certxa.com/launchsite';
    ...
    <div style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); border-radius: 24px; padding: 64px; text-align: center; position: relative; overflow: hidden;">
      ...
      <div style="position: relative; z-index: 2;">
        ...
        <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
          ...
          <a href="/pricing" style="border: 2px solid rgba(255,255,255,0.3); color: white; padding: 14px 30px; border-radius: 12px; font-weight: 500; text-decoration: none;">
            View Pricing
          </a>
        </div>
  ...
  <div class="container">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
      ...
      <div style="text-align: center; padding: 32px; border: 1px solid #e5e7eb; border-radius: 16px;">
        ...
        <a href="/salonos" style="color: #7c3aed; font-weight: 500; text-decoration: none;">Learn more →</a>
      </div>
      ...
      <div style="text-align: center; padding: 32px; border: 1px solid #e5e7eb; border-radius: 16px;">
        ...
        <a href="/online-booking" style="color: #ec4899; font-weight: 500; text-decoration: none;">Learn more →</a>
      </div>
      ...
      <div style="text-align: center; padding: 32px; border: 1px solid #e5e7eb; border-radius: 16px;">
        ...
        <a href="/payments" style="color: #10b981; font-weight: 500; text-decoration: none;">Learn more →</a>
      </div>
    </div>
  </div>
</section>
