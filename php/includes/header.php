...
<header class="site-header">
    <div class="container">
        <nav class="navbar">
            ...
            <div class="nav-links">
                <a href="/dashboard" class="nav-link">SalonOS</a>
                <a href="/" class="nav-link nav-link--active">Launchit</a>
        ...
        <div class="mobile-menu" id="mobileMenu">
            <a href="/dashboard" class="mobile-nav-link">SalonOS</a>
            <a href="/" class="mobile-nav-link">Launchit</a>
