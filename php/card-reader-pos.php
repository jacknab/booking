...
define('PAGE_CANONICAL', 'https://certxa.com/card-reader-pos.php');
define('PAGE_BREADCRUMBS', json_encode([
  ['name'=>'Home','url'=>'https://certxa.com/overview.php'],
  ['name'=>'Card Reader & POS','url'=>'https://certxa.com/card-reader-pos.php'],
]));
define('PAGE_SCHEMA', json_encode([
  [
    '@type'       => 'WebPage',
    '@id'         => 'https://certxa.com/card-reader-pos.php',
    ...
    'url'         => 'https://certxa.com/card-reader-pos.php',
