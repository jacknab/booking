...
const CLIPS = [
  { src: "https://videos.pexels.com/video-files/5757473/5757473-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/5757473/5757473-hd_1280_720_25fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/5756832/5756832-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/5756832/5756832-hd_1280_720_25fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/5757475/5757475-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/5757475/5757475-hd_1280_720_25fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/8540505/8540505-hd_1920_1080_30fps.mp4", fallback: "https://videos.pexels.com/video-files/8540505/8540505-hd_1280_720_30fps.mp4", duration: 8000 },
];
const FALLBACK_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1589923188651-268a9765e432?auto=format&fit=crop&w=1920&q=80",
  "https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?auto=format&fit=crop&w=1920&q=80",
];

export default function LawnCareHeroVideo() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#060E1A]">
      ...
      <motion.div initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 1.2, type: "spring" }} className="absolute left-[6%] bottom-[28%] bg-white/10 backdrop-blur-xl rounded-2xl px-4 py-3 border border-white/20 shadow-xl z-10 pointer-events-none hidden md:flex items-center gap-3">
        <div className="h-9 w-9 rounded-xl bg-[#00D4AA]/20 flex items-center justify-center text-lg">🌿</div>
        <div><p className="text-white font-bold text-sm leading-tight">23 yards this week</p><p className="text-white/50 text-xs">18 regular clients</p></div>
      </motion.div>
