...
const CLIPS = [
  {
    src: "https://videos.pexels.com/video-files/3045540/3045540-hd_1920_1080_25fps.mp4",
    fallback: "https://videos.pexels.com/video-files/3045540/3045540-hd_1280_720_25fps.mp4",
    duration: 8000,
  },
  {
  ...
  {
    src: "https://videos.pexels.com/video-files/4125613/4125613-hd_1920_1080_25fps.mp4",
    fallback: "https://videos.pexels.com/video-files/4125613/4125613-hd_1280_720_25fps.mp4",
    duration: 8000,
  },
  {
    src: "https://videos.pexels.com/video-files/5495854/5495854-hd_1920_1080_25fps.mp4",
    fallback: "https://videos.pexels.com/video-files/5495854/5495854-hd_1280_720_25fps.mp4",
    duration: 8000,
  },
];
...
export default function BarberHeroVideo() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#060E1A]">
      {/* Persistent animated gradient orb */}
      <motion.div
      ...
      {/* Barber pole animated stripe — left edge */}
      <div className="absolute left-0 top-0 bottom-0 w-1.5 z-10 overflow-hidden pointer-events-none">
        <motion.div
          className="w-full"
          animate={{ y: [0, 60] }}
      ...
      >
        ...
        <div>
          <p className="text-white font-bold text-sm leading-tight">247 bookings</p>
...
function VideoClip({
  ...
  return (
    ...
    >
      {hasError ? (
        /* Fallback: animated Ken Burns image */
        <motion.img
          src={imageFallback}
          alt=""
        ...
        >
          ...
          {/* If video fails entirely, show image fallback */}
