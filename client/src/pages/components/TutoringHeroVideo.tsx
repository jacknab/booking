...
const CLIPS = [
  { src: "https://videos.pexels.com/video-files/5212345/5212345-hd_1920_1080_30fps.mp4", fallback: "https://videos.pexels.com/video-files/5212345/5212345-hd_1280_720_30fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/5211898/5211898-hd_1920_1080_30fps.mp4", fallback: "https://videos.pexels.com/video-files/5211898/5211898-hd_1280_720_30fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/8540480/8540480-hd_1920_1080_30fps.mp4", fallback: "https://videos.pexels.com/video-files/8540480/8540480-hd_1280_720_30fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/3945456/3945456-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/3945456/3945456-hd_1280_720_25fps.mp4", duration: 8000 },
];
...
export default function TutoringHeroVideo() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#060E1A]">
      ...
      <motion.div initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 1.2, type: "spring" }} className="absolute left-[6%] bottom-[28%] bg-white/10 backdrop-blur-xl rounded-2xl px-4 py-3 border border-white/20 shadow-xl z-10 pointer-events-none hidden md:flex items-center gap-3">
        ...
        <div><p className="text-white font-bold text-sm leading-tight">16 sessions this week</p><p className="text-white/50 text-xs">12 active students</p></div>
      </motion.div>
