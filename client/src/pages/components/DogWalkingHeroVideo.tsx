...
const CLIPS = [
  { src: "https://videos.pexels.com/video-files/5692294/5692294-hd_1920_1080_30fps.mp4", fallback: "https://videos.pexels.com/video-files/5692294/5692294-hd_1280_720_30fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/4576374/4576374-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/4576374/4576374-hd_1280_720_25fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/3196009/3196009-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/3196009/3196009-hd_1280_720_25fps.mp4", duration: 8000 },
  { src: "https://videos.pexels.com/video-files/7210577/7210577-hd_1920_1080_25fps.mp4", fallback: "https://videos.pexels.com/video-files/7210577/7210577-hd_1280_720_25fps.mp4", duration: 8000 },
];
const FALLBACK_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1561037404-61cd46aa615b?auto=format&fit=crop&w=1920&q=80",
  "https://images.unsplash.com/photo-1450778869180-41d0601e046e?auto=format&fit=crop&w=1920&q=80",
];

export default function DogWalkingHeroVideo() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#060E1A]">
      ...
      <motion.div initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 1.2, type: "spring" }} className="absolute left-[6%] bottom-[28%] bg-white/10 backdrop-blur-xl rounded-2xl px-4 py-3 border border-white/20 shadow-xl z-10 pointer-events-none hidden md:flex items-center gap-3">
        ...
        <div><p className="text-white font-bold text-sm leading-tight">31 walks this week</p><p className="text-white/50 text-xs">22 happy dogs</p></div>
      </motion.div>
